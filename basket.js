    ...
    basket.forEach(data => {
        gridCardContainer.innerHTML += `
                        <div class="card_basket">
                            ...
                            <button style = "padding: 5px 10px; background: lime; border: none; color: white;"  onclick= "plus(${data.id})">+</button>
                            <button style = "padding: 5px 10px; background: red; border: none; color: white;" onclick = "minus(${data.id})">-</button>
                        </div>
